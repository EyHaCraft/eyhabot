            ...
            msg.edit(':eight_pointed_black_star:| **Şimdi de ödülü yaz bakalım**').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  .setFooter(message.author.username + " (WhYBoLu çekiliş sistemi)", message.author.avatarURL);
                  message.guild.channels.find("name" , room).send(' <a:HyperTada:684474972369977406>  **ÇEKİLİŞ BAŞLADI** <a:HyperTada:684474972369977406> ' , {embed: giveEmbed}).then(m => {
                     let re = m.react('🎉');
                     setTimeout(() => {
                       ...
                       .setTitle(title)
                       .setColor("#f558c9")
            .setFooter("(WhYBoLu çekiliş sistemi)")
                       .addField('**Çekiliş Bitti !<a:HyperTada:684474972369977406> **',`**Kazanan : ${gFilter} \nBitiş zamanı** :`)
                       .setTimestamp()
                     m.edit('** <a:HyperTada:684474972369977406> ÇEKİLİŞ BİTTİ <a:HyperTada:684474972369977406> **' , {embed: endEmbed});
                       
                       var embedLel = new Discord.RichEmbed()
                        .setColor("#f558c9")
                        .setDescription("**Ödülünü Moderatörleri Etiketleyerek Alabilirsin!**").setFooter("(WhYBoLu çekiliş sistemi)")
