...
if(!kanal) return message.reply(':x: Yanlış kullanım ! `e!otorol-ayarla #kanal @rol`')

if(!rol) return message.reply(':x: Yanlış kullanım ! `e!otorol-ayarla #kanal @rol`')
...
exports.help = {
  ...
  usage: 'e!otorol-ayarla @rol #kanal'
